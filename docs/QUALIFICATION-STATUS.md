...
|---|---|---|
| Swift/Core suite | The current local-source direct `swift test` terminal run executed **1,720 XCTest cases**, with **13 explicit environment/live skips and zero failures**. | Declared skips remain distinct from passes; publication and installed-build qualification remain separate. |
