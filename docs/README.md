...
| [Rune Forge and Stjornarvald](STJORNARVALD.md) | Pinned policy binding, implemented durable-log contract, non-interference boundary, realization map, and current delivery state |
