...
| [Rune Forge and Stjornarvald](STJORNARVALD.md) | Pinned policy binding, implemented durable-log, all-format catalog, Raven rules, and manager evaluation contracts, non-interference boundary, realization map, and current delivery state |
