...
| [Rune Forge and Stjornarvald](STJORNARVALD.md) | Pinned policy binding, implemented durable-log and all-format source-catalog contracts, non-interference boundary, realization map, and current delivery state |
